#include "Algorithm_318506557_B.h"
#include <iostream>
#include "../AlgorithmRegistration.h"


REGISTER_ALGORITHM(Algorithm_318506557_B);

// Constructor
Algorithm_318506557_B::Algorithm_318506557_B() {
}
...
Step Algorithm_318506557_B::nextStep() {
...
Direction Algorithm_318506557_B::moveInCircle(Coordinates temp) {
    Direction dir;
    int x = temp.getX(); 
    int y = temp.getY();
...
void Algorithm_318506557_B::finishedMappingTheHouse() {
    graph.resize();
...
Step Algorithm_318506557_B::returningToDocking() {
...
int Algorithm_318506557_B::searchLargerRadius() {
...
Step Algorithm_318506557_B::goToLastMappingSpot() {
...
Step Algorithm_318506557_B::goToNewRadius() {
...
int Algorithm_318506557_B::minDistance(int dest) {
...
bool Algorithm_318506557_B::validLocation(Coordinates coor) const {
